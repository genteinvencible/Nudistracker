        ...
        <div className="how-it-works-view">
            <div className="steps-grid-modern">
                ...
                <div className="step-card-modern">
                    ...
                    <h3>5. Exporta tus Datos</h3>
                    <p>Usa "Exportar Datos" en la pestaña "Movimientos" para guardar un backup completo en formato JSON. Podrás restaurarlo más tarde desde la pantalla de inicio.</p>
                </div>
            </div>
        </div>
    );
